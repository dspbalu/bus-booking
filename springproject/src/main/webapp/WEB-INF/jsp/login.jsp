...
<!-- Favicon -->
<link href="${pageContext.request.contextPath}/lib/images/favicon.ico"
	rel="icon">
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.html"><img id="twitter" src="${pageContext.request.contextPath}/lib/images/ticket-icon.png" alt="" title="" /></a>
      ...
      <div class="container jumbotron col-md-5 col-md-offset-7">
        <center>  <h1 class="head">Login</h1></center>
       <form action="/">
      <hr>
         <div id="name1">
...
<br>
   <input tupe="button" id="sub1" class="btn" value="Login">
  </form>
    <br><section id="foot"><h4>if you're already registered <a href="#">click here</a></h4></section>
    <br>     
      </div>
    <!-- @component: footer -->
    ...
    <a href="#">Kesineni Travels </a>
    <a href="#">Morning Star Travels </a>
    <a href="#">KPN Travels </a>
    <a href="#">Kaveri Travels </a><br>
    <a href="#">Kallada Travels </a>
    <a href="#">Kaleswari Travels </a>
    <a href="#">Neeta Travels </a>
    <a href="#">SVR Travels </a>
    <a href="#">Diwakar Travels </a>
    <a href="#">Paulo Travels </a>
    <a href="#">Meghana Travels </a>
    <a href="#">Royal Cruiser Travels </a> 
    <a href="#">SRE_Travels</a>
    <a href="#">SRM Travels</a> 
    <a href="#">HKB Travels</a>
    <a href="#">Rathimeena Travels </a>
    <a href="#">Seabird Travels </a>
    <a href="#">Jai Bharat</a>
    <a href="#">Bharathi</a><br>
	<a href="#">Sri Krishna Travels</a>
	<a href="#">Transit BUS</a><br>
    <a href="#">Parveen Travels </a>
    <a href="#">Gujarat Travels </a>
    <a href="#">Sharma Transport </a>
    <a href="#">Reddy Express</a>
